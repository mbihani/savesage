...
class OAuthConnectionFactory:
    ...
    def __call__(self) -> Any:
        ...
        return psycopg.connect(host=self._host, port=5432, dbname=self._database,
            user=self._user, password=credential.token, sslmode="require")
